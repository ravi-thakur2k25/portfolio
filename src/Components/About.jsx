                        ...
                        <div className="row d-flex justify-content-center">
                            ...
                            <div className="col-12 col-md-10 ">
                                <p className='about-paragraph mt-3'>
                                    I am a passionate fresher with a strong foundation in front-end development and graphic design.
                                    Skilled in HTML, CSS, JavaScript, and popular design tool Adobe Photoshop.
                                    I enjoy creating clean, responsive websites and visually appealing designs.
                                    Quick learner and always eager to grow and improve my skills.
